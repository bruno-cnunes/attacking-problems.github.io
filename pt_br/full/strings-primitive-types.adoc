...
=== Problema: Calculadora de custos universitários
...
[subs=+macros]
....
Bem-vindo à Calculadora de Custos Universitários!
...
armazenamento. Pela seção <<computer-basics#computer-basics>>, você sabe que é possível
...
<<Concatenando valores `String`>> pode ser usado para concatenar um número à
...
saída que vê?
. Converta a solução da calculadora de custos universitários apresentada em
<<Solução: Calculadora de custos universitários>> para usar métodos `JOptionPane` tanto para entrada quanto para saída. Use o cabeçalho com
