...
+
Mas *o que* eles estão fazendo? Essa frequência é a _velocidade de 
...
themes of this book. <<concurrency#concurrency>> and <<synchronization#synchronization>> as well as
